// US national average prices (approx, mid-2024) used for baseline placeholders.
export type Staple = {
  id: string;
  name: string;
  unit: string;
...
export const STAPLES: Staple[] = [
  ...
  { id: "chicken-breast", name: "Chicken Breast", unit: "per lb", avgPrice: 4.20 },
  { id: "ground-beef", name: "Ground Beef", unit: "per lb", avgPrice: 5.50 },
  ...
  { id: "yogurt", name: "Greek Yogurt", unit: "single", avgPrice: 1.30 },
];

// Mocked OCR receipts — used by the simulated capture flow.
// Real device-camera + on-device OCR isn't available on web; we simulate
// deterministic-but-varied receipts so users can experience the full flow.
